		...
		<main>
			<div class="caixa-formulario">
				...
				<form class="formulario-cadastro" method="POST" action="FinalCadastroPJ.php" enctype="multipart/form-data">
					...
					<input type="text" class="input-padrao" id="cnpj" name="cnpj" title="Digite um CNPJ no formato: XX.XXX.XXX/XXXX-XX" placeholder="00.000.000/0000-00" required>
					...
					<input type="text" class="input-padrao" id="cel" name="cel" placeholder="(00) 00000-0000" required>
